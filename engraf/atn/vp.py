...
from engraf.utils.predicates import is_verb, is_none, is_np_head
...
def build_vp_atn(vp: VerbPhrase, ts: TokenStream):
    ...
    # NP (subnetwork)
    after_verb.add_arc(is_np_head, make_run_np_into_atn(ts,fieldname="noun_phrase"), after_np)    # Allow final transition if stream is exhausted
