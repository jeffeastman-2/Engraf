...
from engraf.utils.predicates import is_verb, is_none, is_np_head, is_conjunction_no_consume, is_preposition, any_of, is_tobe, is_adjective, is_number, is_conjunction
...
def build_vp_atn(vp: VerbPhrase, ts: TokenStream):
    ...
    after_adj.add_arc(is_conjunction, lambda _, tok: None, adj_conj)  # Handle "and" between adjectives
