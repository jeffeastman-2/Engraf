...
from engraf.lexer.spatial_policy import (
    EngrafSpatialPolicy,
...
def test_proximity_threshold_is_parameterizable_for_other_unit_systems():
    # Driftmoor in feet would do EngrafSpatialPolicy(proximity_threshold=30.0).
    pol = EngrafSpatialPolicy(proximity_threshold=30.0)
...
def test_spatial_location_dot_test_is_unchanged_by_threshold():
    ...
    pol = EngrafSpatialPolicy(proximity_threshold=0.001)
    above = _Pt(0, 5.0, 0)
    below = _Pt(0, -5.0, 0)
    center = _Pt(0, 0, 0)
