...
from engraf.An_N_Space_Model.demo_scene_setup import setup_demo_scene, print_scene_info, get_common_test_phrases
...
def debug_pp_consumption():
    ...
    print("Comparing Layer 3 vs Layer 4 PP consumption behavior")
    print()
    ...
    # Use the centralized test phrases that include PP tokens
    test_phrases_dict = get_common_test_phrases()
    test_phrases = test_phrases_dict['vector_coordinates'] + test_phrases_dict['complex_spatial_chains'][:2]
